...
if(message.content.startsWith(prefix + "daily")) {
  if(profile[message.author.id].lastDaily != moment().format('day')) {
    ...
    profile[message.author.id].credits += 100000
     message.channel.send(`**${message.author.username} you collect your \`100000\` :dollar: daily pounds**`)
} else {
...
//client.login("token Your Bot Here");  // توكن حقق اذا كنت تريده على ستارت بات شيل \\

client.login(process.env.BOT_TOKEN); //وهنا حط \\ او احذفه لو ماتبيه مرفوع 24 ساعة وعدل فوق ب الريدي 
